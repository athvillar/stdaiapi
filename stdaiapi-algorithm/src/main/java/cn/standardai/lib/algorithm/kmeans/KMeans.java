...
public class KMeans {
	 ...
	 * K
	 */
	public KMeans(List<KMeansNode<?, ?>> nodes, int k) {
		this.nodes = nodes;
		this.k = k;
	}
	 ...
	 * 最大尝试次数
	 */
	public KMeans(List<KMeansNode<?, ?>> nodes, int k, InitMethod initMethod, FinishCondition finishCondition, Integer maxMoveCnt) {
		this.nodes = nodes;
		this.k = k;

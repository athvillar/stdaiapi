...
public abstract class HttpHandler {
	...
	public static JSONObject http(HttpMethod method, String url, Map<String, String> params, JSONObject body, String token) throws AppException {
		...
		if (!"success".equals(result.getString("result"))) {
			throw new AppException(result.getString("message"));
		}
		return result;
	}
